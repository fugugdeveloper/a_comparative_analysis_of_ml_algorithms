...
def classify_quality(metrics):
    ...
    thresholds = {
        ...
        'below average': {'NLOC': 300000, 'Avg_NLOC': 75, 'AvgCCN': 9.5, 'Avg_token': 500, 'Fun_Cnt': 200, 'Warning_cnt': 11,
                    'Fun_Rt': 1.5, 'nloc_Rt': 1.2},
        'average': {'NLOC': 200000, 'Avg_NLOC': 50, 'AvgCCN': 6.5, 'Avg_token': 300, 'Fun_Cnt': 100, 'Warning_cnt': 0,
